...
class Answer
{
    ...
    public function createFulfillment($exercise_id)
    {
    ...
    public function insert($fulfillment_id, $field_id)
    {
        date_default_timezone_set('Europe/Zurich');
    ...
    public function updateById($answer, $answer_id)
    {
    ...
    public function getByFulfillmentId($fulfillment_id)
    {
