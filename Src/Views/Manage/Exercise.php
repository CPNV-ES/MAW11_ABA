            ...
            <table class="records">
                ...
                <?php foreach ($exercises as $exercise) { 
                    ...
                    <tr>
                        <td><?= $exercise["title"]?></td>
                        <td>
                            <a title="Show results" href="#" onclick="document.getElementById('Show-result-form-<?= $exercise["exercise_id"] ?>').submit();"><i class="fa fa-chart-bar"></i></a>
            ...
            <table class="records">
                ...
                <?php foreach ($exercises as $exercise) { 
                    ...
                    <tr>
                        <td><?= $exercise["title"]?></td>
                        <td>
                            <a title="Show results" href="#" onclick="document.getElementById('Show-result-form-closed-<?= $exercise["exercise_id"] ?>').submit();"><i class="fa fa-chart-bar"></i></a>
                            <form id="Show-result-form-closed-<?= $exercise["exercise_id"] ?>" method="POST" action="/exercises/allAnswers" style="display:none;">
                                <input type="hidden" name="exercise_id" value="<?= $exercise["exercise_id"] ?>">
                            </form>
